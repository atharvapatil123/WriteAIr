    ...
    def get_frame(self):
        ...
        while(1):
            ...
            if contours and cv2.contourArea(max(contours, 
                ...
                frame = cv2.line(frame, (0,0), (50,50), [255,0,0], 5)
                ...
                if x1 == 0 and y1 == 0:
                    ...
                    frame = cv2.line(frame, (x1,y1), (x2,y2), [255,0,0], 5)
                ...
                #     cv2.putText(frame,'Clearing Canvas',(100,200), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,0,255), 5, cv2.LINE_AA)
                #     clear = True 
